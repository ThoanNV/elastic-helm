...
* Install it:
  - with Helm 3: `helm install metricbeat ./helm-charts/metricbeat --set imageTag=7.17.21`
  - with Helm 2 (deprecated): `helm install --name metricbeat ./helm-charts/metricbeat --set imageTag=7.17.21`
...
| `imageTag`                     | The Metricbeat Docker image tag                                                                                                                                              | `7.17.21`                             |
