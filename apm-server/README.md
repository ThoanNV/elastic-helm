...
* Install it:
  - with Helm 3: `helm install apm-server ./helm-charts/apm-server --set imageTag=7.17.21`
  - with Helm 2 (deprecated): `helm install --name apm-server ./helm-charts/apm-server --set imageTag=7.17.21`
...
| `imageTag`                  | The APM Server Docker image tag                                                                                                                            | `7.17.21`                           |
