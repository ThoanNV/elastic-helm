...
* Install it:
  - with Helm 3: `helm install logstash ./helm-charts/logstash --set imageTag=7.17.21`
  - with Helm 2 (deprecated): `helm install --name logstash ./helm-charts/logstash --set imageTag=7.17.21`
...
| `imageTag`                | The Logstash Docker image tag                                                                                                                                                                                                        | `7.17.21`                              |
