...
* Install it:
  - with Helm 3: `helm install kibana ./helm-charts/kibana --set imageTag=7.17.21`
  - with Helm 2 (deprecated): `helm install --name kibana ./helm-charts/kibana --set imageTag=7.17.21`
...
| `imageTag`            | The Kibana Docker image tag                                                                                                                                                                    | `7.17.21`                           |
